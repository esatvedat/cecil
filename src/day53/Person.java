...
//      Person other = (Person) obj; // casting
//      //we are verifying that all instance variables are the same
//      if (age != other.age) //if age is not the same, objects are different
//          return false;
//      if (name == null) { // if name of current instance is not null
//          if (other.name != null)  // if name of other instance is not null
//              return false;
